...
void analyzeFrequencies(char *text, uint *keyLengths)
{
   printf("\nAnalyzing frequencies of string: '%s'\n", text);
...
SVFRNA";
   ...
   analyzeFrequencies(cipherText, keyLengths);
   analyzeFrequencies("", keyLengths);
